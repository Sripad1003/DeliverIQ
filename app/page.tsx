      ...
      {isLoggedIn ? (
          ...
          <section className="py-20 px-4">
            <div className="container mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Connect customers with reliable drivers for efficient goods transportation. Get the right vehicle for
                your cargo at the best price.
              </p>
        ...
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mt-4 text-lg leading-7 text-gray-600 dark:text-gray-400">
            Your intelligent transport management system.
          </p>
